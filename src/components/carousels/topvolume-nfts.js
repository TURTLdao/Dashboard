...
export const TopVolumeNftsCarousel = ({ jpgstore_top_volume_data }) => {
  ...
  const nftItem = jpgstore_top_volume_data;
    ...
    <ThemeProvider theme={theme}>
      <Card sx={{
        ...
        <CardHeader
          ...
          title={"Top Traded by Daily Volume"}
        />
...
TopVolumeNftsCarousel.prototypes = {
  sx: PropTypes.object,
};
