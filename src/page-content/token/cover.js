...
export const TokenCover = ({ policy, known_tokens, policy_data }) => {
  const matchedPolicy = Object.values(known_tokens).find((obj) => obj.policy === policy && obj.links);
  const matchedDaoPolicy = Object.values(known_tokens).find((obj) => obj.policy === policy && obj.checktype === 'dao');
...
TokenCover.propTypes = {
  // @ts-ignore
  policy: PropTypes.string.isRequired,
  known_tokens: PropTypes.object.isRequired,
