...
export async function getServerSideProps() {
  const policy = DAO_SUPPORTED_ITEMS.adakonda_coin.policy_full;
  const taptools_id = DAO_SUPPORTED_ITEMS.adakonda_coin.taptools_id;
...
export default function Konda({ token_data, cardano_fiat_data }) {
  const info = DAO_SUPPORTED_ITEMS.adakonda_coin;
