...
export async function getServerSideProps() {
  const policy = DAO_SUPPORTED_ITEMS.rccn_token.policy_full;
  const taptools_id = DAO_SUPPORTED_ITEMS.rccn_token.taptools_id;
...
export default function Rccn({ token_data, cardano_fiat_data }) {
  const info = DAO_SUPPORTED_ITEMS.rccn_token;
