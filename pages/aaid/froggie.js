...
export async function getServerSideProps() {
  const policy = DAO_SUPPORTED_ITEMS.froggie_koin.policy_full;
  const taptools_id = DAO_SUPPORTED_ITEMS.froggie_koin.taptools_id;
...
export default function Froggie({ token_data, cardano_fiat_data }) {
  const info = DAO_SUPPORTED_ITEMS.froggie_koin;
